...
const Leaderboard = () => {
  ...
  const getRankBg = (rank: number) => {
    switch (rank) {
      case 1: return 'bg-gradient-to-r from-yellow-600 to-yellow-700 border-yellow-500';
      case 2: return 'bg-gradient-to-r from-gray-600 to-gray-700 border-gray-500';
      case 3: return 'bg-gradient-to-r from-amber-600 to-amber-700 border-amber-500';
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-6">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-purple-200">Compete with other community members and climb the ranks!</p>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-white text-xl font-bold">Your Current Position</h3>
                  <p className="text-blue-100">Keep climbing to reach the top!</p>
                </div>
              </div>
              <div className="text-right">
                ...
                <p className="text-blue-100">2,450 points</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="flex justify-center gap-4">
          <Button
            ...
            className={activeTab === 'overall' ? 'bg-blue-600' : 'bg-gray-700 border-gray-600 text-gray-300'}
          >
          ...
          <Button
            ...
            className={activeTab === 'monthly' ? 'bg-blue-600' : 'bg-gray-700 border-gray-600 text-gray-300'}
          >
          ...
          <Button
            ...
            className={activeTab === 'weekly' ? 'bg-blue-600' : 'bg-gray-700 border-gray-600 text-gray-300'}
          >
          ...
          {getCurrentData().slice(0, 3).map((leader, index) => (
            <Card key={leader.rank} className={`${getRankBg(leader.rank)} backdrop-blur-sm`}>
              <CardContent className="p-6 text-center">
                ...
                <Badge className="mb-3 bg-white/20 text-white">{leader.badge}</Badge>
                <div className="space-y-2 text-sm">
                  <p className="text-white font-bold text-xl">{leader.points} pts</p>
              ...
              {getCurrentData().map((leader) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-4 gap-4 text-center text-sm">
                    ...
                    <div>
                      <p className="text-white font-bold">{leader.reports}</p>
                      <p className="text-gray-400 text-xs">Reports</p>
                    </div>
                    <div>
                      <p className="text-white font-bold">{leader.recycled}</p>
                      <p className="text-gray-400 text-xs">Recycled</p>
                    </div>
                    <div>
                      <p className="text-white font-bold">{leader.streak}</p>
